...
Claro, aqui está o README atualizado com as informações solicitadas, incluindo comandos específicos para construção e execução da aplicação usando Docker e Docker Compose.
